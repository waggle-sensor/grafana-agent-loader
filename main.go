...
func parseFlags() *config {
	...
	a.Flag("influxdb.token", "The InfluxDB token with write access.").
		Default("").StringVar(&cfg.influxdbToken)
	a.Flag("influxdb.bucket", "The name of the bucket to use for storing samples in InfluxDB.").
		Default("waggle").StringVar(&cfg.influxdbBucket)
	a.Flag("influxdb.organization", "The name of the organization to use for storing samples in InfluxDB.").
		Default("waggle").StringVar(&cfg.influxdbOrganization)
